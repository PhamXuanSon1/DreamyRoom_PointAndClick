	...
	public class SkeletonBinary : SkeletonLoader
	{
		...
		public SkeletonData ReadSkeletonData(Stream file)
		{
			...
			for (int k = 0; k < n2; k++)
			{
				...
				linkedMesh.mesh.DeformAttachment = (linkedMesh.inheritDeform ? ((VertexAttachment)parent2) : linkedMesh.mesh);
		...
		private Attachment ReadAttachment(SkeletonInput input, SkeletonData skeletonData, Skin skin, int slotIndex, string attachmentName, bool nonessential)
		{
			...
			case 2:
			{
				...
				MeshAttachment mesh = attachmentLoader.NewMeshAttachment(skin, name, path2);
				if (mesh == null)
				{
					return null;
				}
			...
			case 3:
			{
				...
				MeshAttachment mesh2 = attachmentLoader.NewMeshAttachment(skin, name, path3);
				if (mesh2 == null)
				{
					return null;
				}
				...
				linkedMeshes.Add(new LinkedMesh(mesh2, skinName, slotIndex, parent, inheritDeform));
				return mesh2;
			}
			case 4:
			{
					...
					case 1:
					{
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline2, bezier++, frame2, 0, time, time12, r, r5, 1f);
								SetBezier(input, timeline2, bezier++, frame2, 1, time, time12, g, g5, 1f);
								SetBezier(input, timeline2, bezier++, frame2, 2, time, time12, b, b5, 1f);
								SetBezier(input, timeline2, bezier++, frame2, 3, time, time12, a, a4, 1f);
								break;
							}
							time = time12;
							r = r5;
					...
					case 2:
					{
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline3, bezier2++, frame3, 0, time2, time13, r2, r6, 1f);
								SetBezier(input, timeline3, bezier2++, frame3, 1, time2, time13, g2, g6, 1f);
								SetBezier(input, timeline3, bezier2++, frame3, 2, time2, time13, b2, b6, 1f);
								break;
							}
							time2 = time13;
							r2 = r6;
					...
					case 3:
					{
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline5, bezier3++, frame4, 0, time3, time14, r3, nr, 1f);
								SetBezier(input, timeline5, bezier3++, frame4, 1, time3, time14, g3, ng, 1f);
								SetBezier(input, timeline5, bezier3++, frame4, 2, time3, time14, b3, nb, 1f);
								SetBezier(input, timeline5, bezier3++, frame4, 3, time3, time14, a2, na, 1f);
								SetBezier(input, timeline5, bezier3++, frame4, 4, time3, time14, r7, nr3, 1f);
								SetBezier(input, timeline5, bezier3++, frame4, 5, time3, time14, g7, ng3, 1f);
								SetBezier(input, timeline5, bezier3++, frame4, 6, time3, time14, b7, nb3, 1f);
								break;
							}
							time3 = time14;
							r3 = nr;
					...
					case 4:
					{
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline6, bezier4++, frame5, 0, time5, time15, r4, nr2, 1f);
								SetBezier(input, timeline6, bezier4++, frame5, 1, time5, time15, g4, ng2, 1f);
								SetBezier(input, timeline6, bezier4++, frame5, 2, time5, time15, b4, nb2, 1f);
								SetBezier(input, timeline6, bezier4++, frame5, 3, time5, time15, r8, nr4, 1f);
								SetBezier(input, timeline6, bezier4++, frame5, 4, time5, time15, g8, ng4, 1f);
								SetBezier(input, timeline6, bezier4++, frame5, 5, time5, time15, b8, nb4, 1f);
								break;
							}
							time5 = time15;
							r4 = nr2;
					...
					case 5:
					{
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline7, bezier5++, frame6, 0, time6, time16, a3, a5, 1f);
								break;
							}
							time6 = time16;
							a3 = a5;
			...
			for (int n4 = input.ReadInt(true); k < n4; k++)
			{
				...
				while (true)
				{
					...
					case 1:
						...
						break;
					case 2:
						SetBezier(input, timeline8, bezier6++, frame7, 0, time7, time17, mix, mix2, 1f);
						SetBezier(input, timeline8, bezier6++, frame7, 1, time7, time17, softness, softness2, scale);
						break;
					}
					time7 = time17;
					mix = mix2;
			...
			for (int n5 = input.ReadInt(true); l < n5; l++)
			{
				...
				while (true)
				{
					...
					case 1:
						...
						break;
					case 2:
						SetBezier(input, timeline10, bezier7++, frame8, 0, time9, time18, mixRotate, mixRotate3, 1f);
						SetBezier(input, timeline10, bezier7++, frame8, 1, time9, time18, mixX, mixX3, 1f);
						SetBezier(input, timeline10, bezier7++, frame8, 2, time9, time18, mixY, mixY3, 1f);
						SetBezier(input, timeline10, bezier7++, frame8, 3, time9, time18, mixScaleX, mixScaleX2, 1f);
						SetBezier(input, timeline10, bezier7++, frame8, 4, time9, time18, mixScaleY, mixScaleY2, 1f);
						SetBezier(input, timeline10, bezier7++, frame8, 5, time9, time18, mixShearY, mixShearY2, 1f);
						break;
					}
					time9 = time18;
					...
					case 2:
					{
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline11, bezier8++, frame9, 0, time10, time19, mixRotate2, mixRotate4, 1f);
								SetBezier(input, timeline11, bezier8++, frame9, 1, time10, time19, mixX2, mixX4, 1f);
								SetBezier(input, timeline11, bezier8++, frame9, 2, time10, time19, mixY2, mixY4, 1f);
								break;
							}
							time10 = time19;
			...
			for (int n7 = input.ReadInt(true); n < n7; n++)
			{
				...
				for (int nn4 = input.ReadInt(true); ii6 < nn4; ii6++)
				{
					...
					for (int nnn = input.ReadInt(true); iii < nnn; iii++)
					{
						...
						VertexAttachment attachment = (VertexAttachment)skin.GetAttachment(slotIndex3, attachmentName);
						if (attachment == null)
						{
						...
						DeformTimeline timeline12 = new DeformTimeline(frameCount5, input.ReadInt(true), slotIndex3, attachment);
						...
						while (true)
						{
							...
							case 1:
								...
								break;
							case 2:
								SetBezier(input, timeline12, bezier9++, frame10, 0, time11, time20, 0f, 1f, 1f);
								break;
							}
							time11 = time20;
							frame10++;
