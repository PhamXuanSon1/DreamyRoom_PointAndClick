		...
		private void ReadAnimation(Dictionary<string, object> map, string name, SkeletonData skeletonData)
		{
			...
			if (map.ContainsKey("slots"))
			{
				foreach (KeyValuePair<string, object> entry in (Dictionary<string, object>)map["slots"])
				{
					...
					int slotIndex3 = FindSlotIndex(skeletonData, slotName);
					Dictionary<string, object> timelineMap5 = (Dictionary<string, object>)entry.Value;
					foreach (KeyValuePair<string, object> timelineEntry3 in timelineMap5)
					{
						...
						case "attachment":
						{
							AttachmentTimeline timeline12 = new AttachmentTimeline(frames3, slotIndex3);
							int frame7 = 0;
							foreach (Dictionary<string, object> keyMap5 in values7)
							{
								timeline12.SetFrame(frame7++, GetFloat(keyMap5, "time", 0f), (string)keyMap5["name"]);
							}
						...
						case "rgba":
						{
							RGBATimeline timeline14 = new RGBATimeline(frames3, frames3 << 2, slotIndex3);
							List<object>.Enumerator keyMapEnumerator7 = values7.GetEnumerator();
							...
							while (true)
							{
								timeline14.SetFrame(frame8, time6, r2, g2, b2, a);
								...
								if (keyMap7.ContainsKey("curve"))
								{
									...
									bezier5 = ReadCurve(curve5, timeline14, bezier5, frame8, 0, time6, time13, r2, nr, 1f);
									bezier5 = ReadCurve(curve5, timeline14, bezier5, frame8, 1, time6, time13, g2, ng, 1f);
									bezier5 = ReadCurve(curve5, timeline14, bezier5, frame8, 2, time6, time13, b2, nb, 1f);
									bezier5 = ReadCurve(curve5, timeline14, bezier5, frame8, 3, time6, time13, a, na, 1f);
								}
								time6 = time13;
								r2 = nr;
								g2 = ng;
							...
							timeline14.Shrink(bezier5);
							timelines.Add(timeline14);
							break;
						}
						case "rgb":
						{
							RGBTimeline timeline15 = new RGBTimeline(frames3, frames3 * 3, slotIndex3);
							List<object>.Enumerator keyMapEnumerator8 = values7.GetEnumerator();
							...
							while (true)
							{
								timeline15.SetFrame(frame10, time7, r3, g3, b3);
								...
								color3 = (string)nextMap6["color"];
								float nr2 = ToColor(color3, 0, 6);
								float ng2 = ToColor(color3, 1, 6);
								float nb2 = ToColor(color3, 2, 6);
								if (keyMap8.ContainsKey("curve"))
								{
									object curve6 = keyMap8["curve"];
									bezier6 = ReadCurve(curve6, timeline15, bezier6, frame10, 0, time7, time14, r3, nr2, 1f);
									bezier6 = ReadCurve(curve6, timeline15, bezier6, frame10, 1, time7, time14, g3, ng2, 1f);
									bezier6 = ReadCurve(curve6, timeline15, bezier6, frame10, 2, time7, time14, b3, nb2, 1f);
								}
								time7 = time14;
								r3 = nr2;
								g3 = ng2;
							...
							timeline15.Shrink(bezier6);
							timelines.Add(timeline15);
							break;
						}
						case "alpha":
						{
							List<object>.Enumerator keyMapEnumerator9 = values7.GetEnumerator();
							keyMapEnumerator9.MoveNext();
							timelines.Add(ReadTimeline(ref keyMapEnumerator9, new AlphaTimeline(frames3, frames3, slotIndex3), 0f, 1f));
							break;
						}
						case "rgba2":
						{
							RGBA2Timeline timeline16 = new RGBA2Timeline(frames3, frames3 * 7, slotIndex3);
							List<object>.Enumerator keyMapEnumerator10 = values7.GetEnumerator();
							...
							while (true)
							{
								timeline16.SetFrame(frame11, time8, r4, g4, b4, a2, r6, g6, b6);
								...
								float nr3 = ToColor(color4, 0);
								float ng3 = ToColor(color4, 1);
								float nb3 = ToColor(color4, 2);
								...
								if (keyMap9.ContainsKey("curve"))
								{
									...
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 0, time8, time16, r4, nr3, 1f);
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 1, time8, time16, g4, ng3, 1f);
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 2, time8, time16, b4, nb3, 1f);
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 3, time8, time16, a2, na2, 1f);
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 4, time8, time16, r6, nr5, 1f);
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 5, time8, time16, g6, ng5, 1f);
									bezier8 = ReadCurve(curve7, timeline16, bezier8, frame11, 6, time8, time16, b6, nb5, 1f);
								}
								time8 = time16;
								r4 = nr3;
								g4 = ng3;
							...
							timeline16.Shrink(bezier8);
							timelines.Add(timeline16);
							break;
						}
						case "rgb2":
						{
							RGB2Timeline timeline13 = new RGB2Timeline(frames3, frames3 * 6, slotIndex3);
							...
							while (true)
							{
								...
								Dictionary<string, object> nextMap7 = (Dictionary<string, object>)keyMapEnumerator6.Current;
								float time15 = GetFloat(nextMap7, "time", 0f);
								color = (string)nextMap7["light"];
								float nr4 = ToColor(color, 0, 6);
								float ng4 = ToColor(color, 1, 6);
								float nb4 = ToColor(color, 2, 6);
								color = (string)nextMap7["dark"];
								...
								if (keyMap6.ContainsKey("curve"))
								{
									...
									bezier7 = ReadCurve(curve8, timeline13, bezier7, frame9, 0, time5, time15, r, nr4, 1f);
									bezier7 = ReadCurve(curve8, timeline13, bezier7, frame9, 1, time5, time15, g, ng4, 1f);
									bezier7 = ReadCurve(curve8, timeline13, bezier7, frame9, 2, time5, time15, b, nb4, 1f);
									bezier7 = ReadCurve(curve8, timeline13, bezier7, frame9, 3, time5, time15, r5, nr6, 1f);
									bezier7 = ReadCurve(curve8, timeline13, bezier7, frame9, 4, time5, time15, g5, ng6, 1f);
									bezier7 = ReadCurve(curve8, timeline13, bezier7, frame9, 5, time5, time15, b5, nb6, 1f);
								}
								time5 = time15;
								r = nr4;
								g = ng4;
			...
			if (map.ContainsKey("bones"))
			{
				foreach (KeyValuePair<string, object> entry2 in (Dictionary<string, object>)map["bones"])
				{
					...
					foreach (KeyValuePair<string, object> timelineEntry2 in timelineMap6)
					{
						...
						{
							int frames2 = values6.Count;
							string timelineName = timelineEntry2.Key;
							switch (timelineName)
							{
							case "rotate":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new RotateTimeline(frames2, frames2, boneIndex), 0f, 1f));
								continue;
							case "translate":
							{
								TranslateTimeline timeline9 = new TranslateTimeline(frames2, frames2 << 1, boneIndex);
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, timeline9, "x", "y", 0f, scale));
								continue;
							}
							case "translatex":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new TranslateXTimeline(frames2, frames2, boneIndex), 0f, scale));
								continue;
							case "translatey":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new TranslateYTimeline(frames2, frames2, boneIndex), 0f, scale));
								continue;
							case "scale":
							{
								ScaleTimeline timeline10 = new ScaleTimeline(frames2, frames2 << 1, boneIndex);
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, timeline10, "x", "y", 1f, 1f));
								continue;
							}
							case "scalex":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new ScaleXTimeline(frames2, frames2, boneIndex), 1f, 1f));
								continue;
							case "scaley":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new ScaleYTimeline(frames2, frames2, boneIndex), 1f, 1f));
								continue;
							case "shear":
							{
								ShearTimeline timeline11 = new ShearTimeline(frames2, frames2 << 1, boneIndex);
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, timeline11, "x", "y", 0f, 1f));
								continue;
							}
							case "shearx":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new ShearXTimeline(frames2, frames2, boneIndex), 0f, 1f));
								continue;
							case "sheary":
								timelines.Add(ReadTimeline(ref keyMapEnumerator5, new ShearYTimeline(frames2, frames2, boneIndex), 0f, 1f));
								continue;
							}
			...
			{
				foreach (KeyValuePair<string, object> timelineMap4 in (Dictionary<string, object>)map["ik"])
				{
					List<object> values5 = (List<object>)timelineMap4.Value;
					...
					IkConstraintData constraint3 = skeletonData.FindIkConstraint(timelineMap4.Key);
					IkConstraintTimeline timeline8 = new IkConstraintTimeline(values5.Count, values5.Count << 1, skeletonData.IkConstraints.IndexOf(constraint3));
					...
					while (true)
					{
						timeline8.SetFrame(frame6, time4, mix, softness, GetBoolean(keyMap4, "bendPositive", true) ? 1 : (-1), GetBoolean(keyMap4, "compress", false), GetBoolean(keyMap4, "stretch", false));
						if (!keyMapEnumerator4.MoveNext())
						{
							break;
						}
						...
						if (keyMap4.ContainsKey("curve"))
						{
							...
							bezier4 = ReadCurve(curve4, timeline8, bezier4, frame6, 0, time4, time12, mix, mix2, 1f);
							bezier4 = ReadCurve(curve4, timeline8, bezier4, frame6, 1, time4, time12, softness, softness2, scale);
						}
						time4 = time12;
						mix = mix2;
						softness = softness2;
					...
					timeline8.Shrink(bezier4);
					timelines.Add(timeline8);
				}
			}
			if (map.ContainsKey("transform"))
			{
				foreach (KeyValuePair<string, object> timelineMap3 in (Dictionary<string, object>)map["transform"])
				{
					List<object> values4 = (List<object>)timelineMap3.Value;
					...
					TransformConstraintData constraint2 = skeletonData.FindTransformConstraint(timelineMap3.Key);
					TransformConstraintTimeline timeline7 = new TransformConstraintTimeline(values4.Count, values4.Count * 6, skeletonData.TransformConstraints.IndexOf(constraint2));
					...
					while (true)
					{
						timeline7.SetFrame(frame5, time3, mixRotate2, mixX2, mixY2, mixScaleX, mixScaleY, mixShearY);
						if (!keyMapEnumerator3.MoveNext())
						{
							break;
						}
						...
						if (keyMap3.ContainsKey("curve"))
						{
							...
							bezier3 = ReadCurve(curve3, timeline7, bezier3, frame5, 0, time3, time11, mixRotate2, mixRotate4, 1f);
							bezier3 = ReadCurve(curve3, timeline7, bezier3, frame5, 1, time3, time11, mixX2, mixX4, 1f);
							bezier3 = ReadCurve(curve3, timeline7, bezier3, frame5, 2, time3, time11, mixY2, mixY4, 1f);
							bezier3 = ReadCurve(curve3, timeline7, bezier3, frame5, 3, time3, time11, mixScaleX, mixScaleX2, 1f);
							bezier3 = ReadCurve(curve3, timeline7, bezier3, frame5, 4, time3, time11, mixScaleY, mixScaleY2, 1f);
							bezier3 = ReadCurve(curve3, timeline7, bezier3, frame5, 5, time3, time11, mixShearY, mixShearY2, 1f);
						}
						time3 = time11;
			...
			if (map.ContainsKey("path"))
			{
				foreach (KeyValuePair<string, object> constraintMap in (Dictionary<string, object>)map["path"])
				{
					...
					foreach (KeyValuePair<string, object> timelineEntry in timelineMap2)
					{
						...
						int frames = values3.Count;
						switch (timelineEntry.Key)
						{
						case "position":
						{
							CurveTimeline1 timeline4 = new PathConstraintPositionTimeline(frames, frames, constraintIndex);
							timelines.Add(ReadTimeline(ref keyMapEnumerator2, timeline4, 0f, (constraint.positionMode == PositionMode.Fixed) ? scale : 1f));
							break;
						}
						case "spacing":
						{
							CurveTimeline1 timeline5 = new PathConstraintSpacingTimeline(frames, frames, constraintIndex);
							timelines.Add(ReadTimeline(ref keyMapEnumerator2, timeline5, 0f, (constraint.spacingMode == SpacingMode.Length || constraint.spacingMode == SpacingMode.Fixed) ? scale : 1f));
							break;
						}
						case "mix":
						{
							PathConstraintMixTimeline timeline6 = new PathConstraintMixTimeline(frames, frames * 3, constraintIndex);
							...
							while (true)
							{
								timeline6.SetFrame(frame4, time2, mixRotate, mixX, mixY);
								if (!keyMapEnumerator2.MoveNext())
								{
									break;
								}
								...
								if (keyMap2.ContainsKey("curve"))
								{
									...
									bezier2 = ReadCurve(curve2, timeline6, bezier2, frame4, 0, time2, time10, mixRotate, mixRotate3, 1f);
									bezier2 = ReadCurve(curve2, timeline6, bezier2, frame4, 1, time2, time10, mixX, mixX3, 1f);
									bezier2 = ReadCurve(curve2, timeline6, bezier2, frame4, 2, time2, time10, mixY, mixY3, 1f);
								}
								time2 = time10;
			...
			if (map.ContainsKey("deform"))
			{
				foreach (KeyValuePair<string, object> deformMap in (Dictionary<string, object>)map["deform"])
				{
					...
					{
						int slotIndex2 = FindSlotIndex(skeletonData, slotMap.Key);
						foreach (KeyValuePair<string, object> timelineMap in (Dictionary<string, object>)slotMap.Value)
						{
							...
							VertexAttachment attachment = (VertexAttachment)skin.GetAttachment(slotIndex2, timelineMap.Key);
							if (attachment == null)
							{
							...
							DeformTimeline timeline3 = new DeformTimeline(values2.Count, values2.Count, slotIndex2, attachment);
							...
							while (true)
							{
								...
								timeline3.SetFrame(frame3, time, deform);
								if (!keyMapEnumerator.MoveNext())
								{
									break;
								}
								...
								if (keyMap.ContainsKey("curve"))
								{
									...
									bezier = ReadCurve(curve, timeline3, bezier, frame3, 0, time, time9, 0f, 1f, 1f);
								}
								time = time9;
								keyMap = nextMap;
								frame3++;
